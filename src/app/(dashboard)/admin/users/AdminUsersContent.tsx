...
export default function AdminUsersContent({ users }: AdminUsersContentProps) {
      ...
      <Card className="bg-white border-slate-200 shadow-none overflow-hidden">
        <CardHeader className="flex flex-row items-center justify-between border-b border-slate-100 pb-4">
          ...
          <Button
            variant="outline"
            size="sm"
            className="border-slate-200 text-slate-600 hover:bg-slate-50 text-xs h-7"
          >
            Export CSV
          </Button>
        </CardHeader>
                  ...
                  <TableRow key={user.id} className="border-slate-100 hover:bg-slate-50 transition-colors">
                    ...
                    <TableCell>
                      {user.is_admin ? (
                        ...
                        <Badge
                          variant="outline"
                          className="text-slate-500 border-slate-200 text-[10px] font-semibold"
                        >
                          User
                        </Badge>
                      )}
